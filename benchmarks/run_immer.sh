...
rm -rf $PMEM/bench*; taskset $CPU_GROUP ./bench -i immer -d map -f $PMEM/bench -e 1000000 -n 1000000 -t 1 -w 50 -p rand -s120

rm -rf $PMEM/bench*; taskset $CPU_GROUP ./bench -i immer -d set -f $PMEM/bench -e 1000000 -n 1000000 -t 1 -w 100 -p rand -s120
rm -rf $PMEM/bench*; taskset $CPU_GROUP ./bench -i immer -d set -f $PMEM/bench -e 1000000 -n 1000000 -t 1 -w 50 -p rand -s120

rm -rf $PMEM/bench*; taskset $CPU_GROUP ./bench -i immer -d queue -f $PMEM/bench -e 1000000 -n 1000000 -t 1 -w 100 -p rand -s120
rm -rf $PMEM/bench*; taskset $CPU_GROUP ./bench -i immer -d queue -f $PMEM/bench -e 1000000 -n 1000000 -t 1 -w 75 -p rand -s120

rm -rf $PMEM/bench*; taskset $CPU_GROUP ./bench -i immer -d stack -f $PMEM/bench -e 1000000 -n 1000000 -t 1 -w 100 -p rand -s120
rm -rf $PMEM/bench*; taskset $CPU_GROUP ./bench -i immer -d stack -f $PMEM/bench -e 1000000 -n 1000000 -t 1 -w 75 -p rand -s120

rm -rf $PMEM/bench*; taskset $CPU_GROUP ./bench -i immer -d vector -f $PMEM/bench -e 1000000 -n 1000000 -t 1 -w 100 -p rand -s120
rm -rf $PMEM/bench*; taskset $CPU_GROUP ./bench -i immer -d vector -f $PMEM/bench -e 1000000 -n 1000000 -t 1 -w 50 -p rand -s120
...
rm -rf $PMEM/bench_no_flush*; taskset $CPU_GROUP ./bench_no_flush -i immer -d map -f $PMEM/bench_no_flush -e 1000000 -n 1000000 -t 1 -w 50 -p rand -s120
...
rm -rf $PMEM/bench_no_flush*; taskset $CPU_GROUP ./bench_no_flush -i immer -d set -f $PMEM/bench_no_flush -e 1000000 -n 1000000 -t 1 -w 50 -p rand -s120
...
rm -rf $PMEM/bench_no_flush*; taskset $CPU_GROUP ./bench_no_flush -i immer -d queue -f $PMEM/bench_no_flush -e 1000000 -n 1000000 -t 1 -w 75 -p rand -s120
...
rm -rf $PMEM/bench_no_flush*; taskset $CPU_GROUP ./bench_no_flush -i immer -d stack -f $PMEM/bench_no_flush -e 1000000 -n 1000000 -t 1 -w 75 -p rand -s120
...
rm -rf $PMEM/bench_no_flush*; taskset $CPU_GROUP ./bench_no_flush -i immer -d vector -f $PMEM/bench_no_flush -e 1000000 -n 1000000 -t 1 -w 50 -p rand -s120
...
rm -rf $PMEM/bench*; taskset $CPU_GROUP ./bench -i pmdk -d queue -f $PMEM/bench -e 1000000 -n 1000000 -t 1 -w 75 -p rand -s120

rm -rf $PMEM/bench*; taskset $CPU_GROUP ./bench -i pmdk -d stack -f $PMEM/bench -e 1000000 -n 1000000 -t 1 -w 100 -p rand -s120
rm -rf $PMEM/bench*; taskset $CPU_GROUP ./bench -i pmdk -d stack -f $PMEM/bench -e 1000000 -n 1000000 -t 1 -w 75 -p rand -s120
