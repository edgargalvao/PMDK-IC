...
{
export LD_LIBRARY_PATH=/home/swapnilh/pmdk/src/tx-nondebug/:/home/swapnilh/pmdk/src/examples/libpmemobj/hashmap/:/home/swapnilh/pmdk-stuff/nvm_malloc/:$LD_LIBRARY_PATH
...
rm -rf $PMEM/bfs*; taskset $CPU_GROUP $BFS_DIR/pmdk_bfs $PMEM/bfs $BFS_DIR/flickr.mtx0 
} > pmdk14_no_flush.log 2>> error.log
