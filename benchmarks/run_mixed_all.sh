...
rm -rf $PMEM/bfs*; taskset $CPU_GROUP $BFS_DIR/mod_bfs $PMEM/bfs $BFS_DIR/flickr.mtx0 
...
rm -rf $PMEM/bfs*; taskset $CPU_GROUP $BFS_DIR/mod_bfs_noflush $PMEM/bfs $BFS_DIR/flickr.mtx0 
...
rm -rf $PMEM/bfs*; taskset $CPU_GROUP $BFS_DIR/pmdk_bfs $PMEM/bfs $BFS_DIR/flickr.mtx0 
