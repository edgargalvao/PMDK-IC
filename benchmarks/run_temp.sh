...
{
rm -rf $PMEM/bfs*; perf stat -e L1-dcache-load-misses,L1-dcache-loads,L1-dcache-stores,LLC-load-misses  $GRAPH_DIR/mod_bfs $PMEM/bfs $GRAPH_DIR/flickr.mtx0 1
...
rm -rf $PMEM/bfs*; perf stat -e L1-dcache-load-misses,L1-dcache-loads,L1-dcache-stores,LLC-load-misses  $GRAPH_DIR/mod_bfs $PMEM/bfs $GRAPH_DIR/flickr.mtx0 
...
rm -rf $PMEM/bfs*; perf stat -e L1-dcache-load-misses,L1-dcache-loads,L1-dcache-stores,LLC-load-misses  $GRAPH_DIR/pmdk_bfs $PMEM/bfs $GRAPH_DIR/flickr.mtx0 1
...
rm -rf $PMEM/bfs*; perf stat -e L1-dcache-load-misses,L1-dcache-loads,L1-dcache-stores,LLC-load-misses  $GRAPH_DIR/pmdk_bfs $PMEM/bfs $GRAPH_DIR/flickr.mtx0
